    ...
    <div class="py-8">
        ...
        <div class="my-2 flex sm:flex-row flex-col">
            ...
            <div class="block relative">
                ...
                <input placeholder="Search" type="text" wire:model.debounce.300ms="search"
                    ...
                    <thead>
                        <tr>
                            <th
                                ...
                                ID @include('components.table.sort', ['field' => 'name'])
                            </th>
                            <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Name @include('components.table.sort', ['field' => 'name'])
                            </th>
                            <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Email @include('components.table.sort', ['field' => 'email'])
                            </th>
                            <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Created At @include('components.table.sort', ['field' => 'created_at'])
                            </th>
                            <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Updated At @include('components.table.sort', ['field' => 'updated_at'])
                            </th>
                            <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                Status
