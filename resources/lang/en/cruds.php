...
return [
    ...
    'announcementManagement' => [
        ...
        'title_singular' => 'Announcement management',
    ],
    'venue-courtManagement' => [
        'title'          => 'Court management',
        'title_singular' => 'Court management',
    ],
    'reported-contentManagement' => [
        'title'          => 'Reported content',
        'title_singular' => 'Reported content',
    ],
    'permission' => [
        'title'          => 'Permissions',
    ...
    'venue' => [
        ...
        'fields' => [
            ...
            'type' => 'Type',
            'currency' => 'Currency',
            'start_open_time' => 'Start time',
            'end_open_time' => 'Close time',
    ...
    'reported-type' => [
        'title' => 'Reported Type',
        'create' => 'Reported Type',
        'title_singular' => 'Reported Type',
        'fields' => [
            'id'                => 'ID',
            'no'                => 'No',
            'code'              => 'Code',
